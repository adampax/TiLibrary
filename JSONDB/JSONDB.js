...
exports.variables.debug = false;

// the variables below are used for string comparison operations
exports.variables.$eq = "$eq";
exports.variables.$ne = "$ne";
exports.variables.$exists = "$exists";
exports.variables.$size = "$size";
exports.variables.$within = "$within";
exports.variables.$gt = "$gt";
exports.variables.$gte = "$gte";
exports.variables.$lt = "$lt";
exports.variables.$lte = "$lte";
exports.variables.$in = "$in";
exports.variables.$in = "$nin";
exports.variables.$or = "$or";
exports.variables.$sort = "$sort";
exports.variables.$unset = "$unset";
exports.variables.$inc = "$inc";
exports.variables.$set = "$set";

// a cache used to store traversal information for objects between inner loop iterations
exports.variables.tcache = {};

/**
 * Global constants
 */
exports.constants.INDEX_TYPE_B_TREE = 0;
exports.constants.INDEX_TYPE_UNIQUE = 1;
exports.constants.DEFAULT_API_HOST = 'api.mongolab.com';
exports.constants.DEFAULT_FS_DIR = Titanium.Filesystem.applicationDataDirectory;
exports.constants.ID_FIELD = '$id';
exports.constants.REF_FIELD = '$ref';

/**
 * the JSONDB database interface class
 * @constructor
 */
exports.classes.Database = function() {
  ...
  this.getCollection = function(name, secret, path, override) {
    ...
    var collection = new exports.classes.Collection(name, secret, path, override);
    collection.open();
 ...
 */
exports.classes.MongoRESTManager = function(name, host, key, query) {

  if(host == undefined) {
    host = exports.constants.DEFAULT_API_HOST;
  }
  ...
  this.save = function(collection) {
    ...
    for(var k in collection._objects) {
      obj = exports.functions.cloneObject(collection._objects[k]);
  ...
  this._normalizeObjectIds = function(o) {
    for(var k in o) {
      if(k == exports.constants.ID_FIELD) {
        if(exports.constants.REF_FIELD in o) {
          o.$id = {$oid: o.$id};
          o.$ref = this._cn;
        } else {
          o._id = {$oid: o.$id};
  ...
  this._deleteDocuments = function() {
    ...
    var k = this._key;
    var o = exports.objects.Log.find({cl:this._name, cm:'delete'});
    ...
    o.forEach(function(d) {
      ...
      xhr.onload = function(e) {
        ...
        exports.objects.Log.remove({$id:d.$id});
        exports.objects.Log.commit();
 ...
 * @constructor
 */
exports.classes.FilesystemManager = function() {
  ...
  this.load = function(filename, secret, path) {
    if(path == undefined) {
      path = exports.constants.DEFAULT_FS_DIR;
    }
    filename += '.json';
    var file = Titanium.Filesystem.getFile(path, filename);
    if (file.exists()) {
      var data = JSON.parse(file.read());
      if(exports.objects.CryptoProvider.verifySignature(data, secret, data._salt) == false) {
  ...
  this.save = function(filename, data, secret, path) {
    ...
    data._sig = exports.objects.CryptoProvider.signData(data, secret, data._salt);
    var file = Titanium.Filesystem.getFile(path, filename);
 ...
 * @constructor
 */
exports.classes.CryptoProvider = function() {
 ...
 */
exports.classes.BTreeIndex = function(name, definition, collection) {
  ...
  this.getType = function() {
    return exports.constants.INDEX_TYPE_B_TREE;
  }
  ...
  this.index = function() {
    ...
    exports.functions.debug('building index ' + this._name + ' with ' + this._count + ' nodes took ' + ((new Date()).getTime() - ts) + ' ms');
  };
  ...
  this._recursivelyBuildIndex = function(btree, keys, order, objects) {
    ...
    objects.forEach(function(object) {
      exports.variables.tcache = {};
      k3 = exports.functions.traverse(k, object);
      if(k3 !== undefined) {
        if(o[k3] == undefined) {
          o[k3] = [];
          k2.push(k3);
  ...
  this.find = function(query) {
    ...
    var or = null;
    if(exports.variables.$or in query) {
      or = query.$or;
      delete query[exports.variables.$or];
    }
  ...
  this._recursiveFind = function(query, leaf, i, o, a) {
    ...
    if(v instanceof RegExp) {
      ...
      for(var k in leaf) {
        ...
        for(var f in v) {
          switch(f) {
            case exports.variables.$eq:
              if(k != v[f]) {
                include = false;
              }
              break;

            case exports.variables.$ne:
              if(k == v[f]) {
                include = false;
              }
              break;

            case exports.variables.$gt:
              if(k <= v[f]) {
                include = false;
              }
              break;

            case exports.variables.$gte:
              if(k < v[f]) {
                include = false;
              }
              break;

            case exports.variables.$lt:
              if(k >= v[f]) {
                include = false;
              }
              break;

            case exports.variables.$lte:
              if(k > v[f]) {
                include = false;
              }
              break;
  ...
  this.insert = function(o) {
    for(var k in this._definition) {
      if(exports.functions.traverse(k, o) == undefined) {
        return false;
      }
    }
    this.remove(o);
 ...
 */
exports.classes.Collection = function(name, secret, path, override) {
  ...
  this._indexes = {};
  this._indexed = false;
  this._io = exports.objects.FilesystemManager;
  ...
  this.ensureIndex = function(definition) {
    var d = exports.functions.sortObjectKeys(definition);
    var n = exports.functions.generateIndexName(d, false);
    if(n in this._indexes) {
      return;
    } else {
      this._indexes[n] = new exports.classes.BTreeIndex(n, d, this);
  ...
  this.selectIndex = function(query) {
    var n = exports.functions.generateIndexName(exports.functions.sortObjectKeys(query), false);
    if(n in this._indexes) {
      exports.functions.debug('using index ' + n);
      return this._indexes[n];
    }
    if(exports.functions.sizeOf(this._indexes) == 0) {
      this._indexed = false;
    }
    return false;
  };
  ...
  this.initializeAPI = function(host, key, query) {
    this.API._api = new exports.classes.MongoRESTManager(this._collection._name, host, key, query);
  };
  ...
  this.sizeOf = function() {
    return exports.functions.sizeOf(this._collection._objects);
  };
    ...
    for(var key in objects) {
      if(typeof(objects[key]) === 'object' && objects[key] !== null) {
        if('$ref' in objects[key]) {
          objects[key] = new exports.classes.DBRef(objects[key]);
        } else {
  ...
  this.find = function(query, conditions) {
    ...
    if(exports.constants.ID_FIELD in query) {
      r = [];
    ...
    var closure = exports.objects.QueryCompiler.compile(query);
    ...
    if(typeof(conditions) !== 'undefined') {
      if('$sort' in conditions) {
        ...
        exports.functions.$sort(tuples, key, order);
      }
    ...
    exports.functions.debug('exports.classes.Collection.find (' + this._collection._name + ':' + exports.functions.stringify(query) + ' , ' +  exports.functions.stringify(conditions) + ') took ' + ((new Date()).getTime() - ts) + ' ms');
    return tuples;
  };
  ...
  this.getAll = function() {
    ...
    exports.functions.debug('exports.classes.Collection.getAll (' + this._collection._name + ') took ' + ((new Date()).getTime() - ts) + ' ms');
    return objects;
  };
  ...
  this.save = function(o) {
    var ts = (new Date()).getTime();
    if(!(exports.constants.ID_FIELD in o)) {
      o.$id = exports.functions.generateBSONIdentifier();
  ...
  this.update = function(query, updates, conditions, upsert) {
    ...
    var closure = exports.objects.MutateCompiler.compile(updates);
    ...
    exports.functions.debug('exports.classes.Collection.update (' + this._collection._name + ':' + exports.functions.stringify(updates) + ') took ' + ((new Date()).getTime() - ts) + ' ms');
  ...
  this.remove = function(query, conditions) {
    ...
    if(this._indexed == true) {
      exports.functions.debug('took ' + ((new Date()).getTime() - ts2) + ' ms to update all indexes for ' + objects.length + ' records');
    }
    if(r) {
      exports.objects.Log.commit();
    }
    ...
    exports.functions.debug('exports.classes.Collection.remove (' + this._collection._name + ') took ' + ((new Date()).getTime() - ts) + ' ms');
    return objects.length;
  };
 ...
 */
exports.classes.DBRef = function(struct) {

  if(typeof(struct) !== 'object'
  || !(exports.constants.REF_FIELD in struct)
  || !(exports.constants.ID_FIELD in struct)) {
  ...
  this.resolve = function() {
    var o = exports.objects.Database.getCollection(this.$ref).find({$id:this.$id});
    if(o !== false) {
      return o[0];
    }
    return false;
 ...
 * @constructor
 */
exports.classes.QueryClosure = function(query) {
 ...
 * @constructor
 */
exports.classes.QueryCompiler = function() {
  ...
  this.compile = function(query) {
    var closure = new exports.classes.QueryClosure(query);
  ...
  this._compile = function(query, closure, or) {
    for(var key in query) {
      ...
      switch(typeof(value)) {
          ...
          if(key == exports.variables.$or) {
            ...
            for(var func in value) {
              switch(func)
              {
                case exports.variables.$eq:
                case exports.variables.$ne:
                case exports.variables.$exists:
                case exports.variables.$size:
                case exports.variables.$within:
                case exports.variables.$gt:
                case exports.variables.$gte:
                case exports.variables.$lt:
                case exports.variables.$lte:
                case exports.variables.$in:
                case exports.variables.$sort:
                case exports.variables.$unset:
                case exports.variables.$inc:
                case exports.variables.$set:
                  this._addFunction(closure, exports.functions[func], [key, value[func]], or);
                  break;
              }
            }
          }
        ...
        default:
          this._addFunction(closure, exports.functions.$eq, [key, value], or);
          break;
      }
    }
  };
 ...
 * @constructor
 */
exports.classes.MutateCompiler = function() {
  ...
  this.compile = function(updates) {
    var closure = new exports.classes.QueryClosure(updates);
      ...
      switch(key)
      {
        ...
        case exports.variables.$set:
          for(var skey in updates[key]) {
            ...
            closure.addUpdateFunction(exports.functions[key], args);
          }
          break;
      }
    }
 ...
 */
exports.functions.$eq = function(a, b, c) {
  var v = exports.functions.traverse(a, c);
  if(v === undefined) {
    return false;
  }
...
exports.functions.$ne = function(a, b, c) {
  var v = exports.functions.traverse(a, c);
  if(v === undefined) {
    return false;
  }
...
exports.functions.$exists = function(a, yes, b) {
  var v = exports.functions.traverse(a, b);
  if(yes) {
    return v !== undefined;
  }
  return v === undefined;
...
exports.functions.$size = function(a, b, c) {
  var v = exports.functions.traverse(a, c);
...
exports.functions.$within = function(a, b, c) {
  var v = exports.functions.traverse(a, c);
...
exports.functions.$gt = function(a, b, c) {
  return exports.functions.traverse(a, c) > b;
};

exports.functions.$gte = function(a, b, c) {
  return exports.functions.traverse(a, c) >= b;
};

exports.functions.$lt = function(a, b, c) {
  return exports.functions.traverse(a, c) < b;
};

exports.functions.$lte = function(a, b, c) {
  return exports.functions.traverse(a, c) <= b;
};

exports.functions.$in = function(a, b, c) {
  var v = exports.functions.traverse(a, c);
...
exports.functions.$nin = function(a, b, c) {
  return !exports.functions.$in(a, b, c);
};

exports.functions.$or = function(a, b, c) {
  return exports.functions.traverse(a, b) !== undefined;
};

exports.functions.$sort = function(c, a, b) {
  switch(b) {
    case -1: // descending
      exports.functions.debug('exports.functions.$sort: descending, ' + a);
      c.sort(function(v1, v2){return v2[a] - v1[a];});
      break;

    case 0: // random
      exports.functions.debug('exports.functions.$sort: random, ' + a);
      exports.functions.shuffle(c);
      break;

    case 1: // ascending
      exports.functions.debug('exports.functions.$sort: ascending, ' + a);
      c.sort(function(v1, v2){return v1[a] - v2[a];});
      break;

    case 2: // alphabetically
      exports.functions.debug('exports.functions.$sort: alphabetically, ' + a);
    ...
    case 3: //  reverse
      exports.functions.debug('exports.functions.$sort: reverse, ' + a);
      c.sort(function(v1, v2){
        if(v2[a] < v1[a]) {
          return -1;
        } else if(v2[a] > v1[a]) {
...
exports.functions.$set = function(name, value, tuple, upsert) {
  var parts = exports.functions.truncatePath(name);
  if(parts === false) {
    exports.functions.$_upsert(name, value, tuple, upsert, false);
  } else {
    var stuple = exports.functions.traverse(parts[0], tuple);
    exports.functions.$_upsert(parts[1], value, stuple, upsert, false);
  }
}

exports.functions.$unset = function(name, value, tuple, upsert) {
  var parts = exports.functions.truncatePath(name);
  if(parts === false) {
    delete tuple[name];
  } else {
    var stuple = exports.functions.traverse(parts[0], tuple, false);
    delete stuple[name];
  }
}

exports.functions.$inc = function(name, value, tuple, upsert) {
  var parts = exports.functions.truncatePath(name);
  if(parts === false) {
    exports.functions.$_upsert(name, value, tuple, upsert, true);
  } else {
    var stuple = exports.functions.traverse(parts[0], tuple);
    exports.functions.$_upsert(parts[1], value, stuple, upsert, true);
  }
}

exports.functions.$_upsert = function(name, value, tuple, upsert, increment) {
  if(name in tuple) {
    if(increment) {
      tuple[name] += value;
    } else {
...
exports.factoryDBRef = function(collection, id) {
  return new exports.classes.DBRef({$ref:collection, $id:id});
};
...
exports.factory = function(name, secret, path, override) {
  return exports.objects.Database.getCollection(name, secret, path, override);
};
...
exports.debug = function(semaphor) {
  exports.variables.debug = semaphor;
};
...
exports.storageLocation = function(path) {
  exports.constants.DEFAULT_FS_DIR = path;
};
 ...
 * @return void
 */
exports.functions.debug = function(message) {
  if(exports.variables.debug == true) {
    Ti.API.info(message);
  }
};
 ...
 */
exports.functions.randomFromTo = function(from, to) {
 ...
 * @return string
 */
exports.functions.generateBSONIdentifier = function() {
  ...
  var pid = exports.functions.randomFromTo(1000, 9999).toString(16);
  while(pid.length < 4) {
    pid = '0' + pid;
  }
  var inc = exports.functions.randomFromTo(100000, 999999).toString(16);
  while(inc.length < 6) {
    inc = '0' + inc;
  }
 ...
 * @return object
 */
exports.functions.generateMongoDate = function() {
 ...
 * @return array
 */
exports.functions.truncatePath = function(path) {
 ...
 * @return mixed
 */
exports.functions.traverse = function(path, object) {
  if(path in exports.variables.tcache) {
    return exports.variables.tcache[path];
  }
  var t = function(p, o) {
    if(o === undefined) {
      return undefined;
  ...
  exports.variables.tcache[path] = t(path.split('.'), object);
  return exports.variables.tcache[path];
};
 ...
 * @return string
 */
exports.functions.stringify = function(o) {
  var clone = {};
  for(var key in o) {
 ...
 * @return void
 */
exports.functions.shuffle = function(c) {
 ...
 * @return integer
 */
exports.functions.sizeOf = function(o) {
    var size = 0, key;
    for (key in o) {
 ...
 * @return object
 */
exports.functions.sortObjectKeys = function(object) {
  var o = {};
  var k = [];
 ...
 * @return string
 */
exports.functions.generateIndexName = function(o, unique) {
  var n = [];
  for(var k in o) {
    if(k == exports.variables.$or) {
      continue;
    }
    n.push(k);
  }
 ...
 * @return object
 */
exports.functions.cloneObject = function(o) {
  var c = {};
  for(var a in o) {
    if(typeof(o[a]) == "object") {
      c[a] = exports.functions.cloneObject(o[a]);
    } else {
      c[a] = o[a];
    }
  }
 ...
 */
exports.objects.FilesystemManager = new exports.classes.FilesystemManager();
exports.objects.CryptoProvider = new exports.classes.CryptoProvider();
exports.objects.Database = new exports.classes.Database();
exports.objects.QueryCompiler = new exports.classes.QueryCompiler();
exports.objects.MutateCompiler = new exports.classes.MutateCompiler();

// the object deletion log for collections linked to MongoDB collections
exports.objects.Log = exports.factory('___log', 'repl:C7E7CB377BADE1D68BA0FFBD03347CA18D746817AC50CE407EA40BE5677ACB9D', undefined, true);