(function(){
 ...
 // Baseline setup
  ...
  // Save the previous value of the `EventVat` variable.
  var previousEventEmitter = root.EventVat;
  ...
  if (typeof exports !== 'undefined') {
    if (typeof module !== 'undefined' && module.exports) {
      exports = module.exports = EventVat;
    }
    exports.EventVat = EventVat;
  } else {
    root['EventVat'] = EventVat;
  }

  // Current version.
  EventVat.VERSION = '0.2.0';

  var EventEmitter, EventVat;

  if(!EventEmitter && require) {
  ...
  for (var member in EventEmitter.prototype) {
    p[member] = EventEmitter.prototype[member];
  }

  p.publish     = EventEmitter.prototype.emit;
  p.subscribe   = EventEmitter.prototype.on;
  p.unsubscribe = EventEmitter.prototype.removeListener;
